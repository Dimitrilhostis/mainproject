...
export default function SideBar({
  ...
  return (
    <aside
      ref={sidebarRef}
      className="relative h-screen flex-col justify-between px-2 bg-gray-50 border-r border-gray-200 shadow-lg overflow-hidden transition-[width] duration-100 ease-out hidden md:flex"
